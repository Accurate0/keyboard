...
//    ├──────┬──────┬──────┼───┴───┴───┴───┴───┴───┴───┴───┼──────┼───────┼───┬──────┼──────┼──────┤
//    │ lctl │ lgui │ lalt │              spc              │ ralt │ MO(1) │   │ left │ down │ end  │
//    └──────┴──────┴──────┴───────────────────────────────┴──────┴───────┘   └──────┴──────┴──────┘
[0] = LAYOUT_65_ansi_blocker(
  ...
  KC_LCTL , KC_LGUI , KC_LALT ,                          KC_SPC                          , KC_RALT , MO(1)   ,           KC_LEFT , KC_DOWN , KC_END
),
...
enum via_secondrow_enable { id_is_second_rgb_row_active = 0 };
